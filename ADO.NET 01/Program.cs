...
//string connectionString = @"Server=DESKTOP-DR3DK4Q\MSSQLSERVER02;Integrated Security=True;Database=AdoTest;Server Certificate=True;Encrypt = False";

//sqlConnection = new SqlConnection(connectionString);

//string insertQuery = @"INSERT INTO Authors(FirstName,LastName) 
//                      VALUES('Murad','Veliyev')";
